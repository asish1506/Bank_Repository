...
public class BankControllerTest {
    ...
    public void retrieveDetailsForCourse() throws Exception {
        ...
        Mockito.when(bankService.retrieveCourse(Mockito.anyString(), Mockito.anyString())).thenReturn(mockCourse);
    ...
    public void createStudentCourse() throws Exception {
        ...
        Mockito.when(bankService.addCourse(Mockito.anyString(), Mockito.any(Course.class))).thenReturn(mockCourse);
